 ...
 */
final class Version20260416113208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE follow (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, follower_id INT NOT NULL, followed_id INT NOT NULL, INDEX IDX_68344470AC24F853 (follower_id), INDEX IDX_68344470D956F010 (followed_id), UNIQUE INDEX unique_follow (follower_id, followed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
